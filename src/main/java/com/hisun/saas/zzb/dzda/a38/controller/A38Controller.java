...
public class A38Controller extends BaseController {
    ...
    public
    @ResponseBody
    Map<String, Object> save(@ModelAttribute A38Vo vo) throws GenericException {
...
//            entity.setSjzt("1");
    ...
    public
    @ResponseBody
    Map<String, Object> update(@ModelAttribute A38Vo vo, HttpServletRequest request) throws GenericException {
        Map<String, Object> returnMap = new HashMap<String, Object>();
        Map<String, String> vMap = ValidateUtil.validAll(vo);
    ...
    public
    @ResponseBody
    Map<String, Object> updateSjzt(String a38Ids, String sjzt) throws GenericException {
        Map<String, Object> returnMap = new HashMap<String, Object>();
    ...
    public
    @ResponseBody
    Map<String, Object> uploadFile(@RequestParam(value = "zbdaFile", required = false) MultipartFile zbdaFile, HttpServletResponse resp) throws IOException {
        Map<String, Object> map = new HashMap<>();
    ...
    private void buildParam(DakVo queryVo, String a0101Query, String gbztCodeQuery, String daztCodeQuery, String gbztContentQuery,
                            String daztContentQuery, String dabhQuery, String smxhQuery) {
        ...
        if (StringUtils.isNotBlank(dabhQuery))
            queryVo.setDabh(dabhQuery);
        if (StringUtils.isNotBlank(smxhQuery))
            queryVo.setSmxh(smxhQuery);
    }

    @RequiresPermissions("a38:*")
    @RequestMapping("/dagl/download")
    public void download(HttpServletResponse resp, HttpServletRequest req,
                         String dabhQuery, String smxhQuery, String a0101Query, String gbztCodeQuery,
                         String daztCodeQuery, String gbztContentQuery, String daztContentQuery) {
        String filePath = "";
        try {
            ...
            this.buildParam(queryA38Vo, a0101Query, gbztCodeQuery, daztCodeQuery, gbztContentQuery, daztContentQuery, dabhQuery, smxhQuery);
            UserLoginDetails userLoginDetails = UserLoginDetailsUtil.getUserLoginDetails();
            List<A38> resultList = a38Service.list(this.a38Service.getGjcxHql(queryA38Vo, userLoginDetails), new ArrayList<Object>(), 1, 10000);
            filePath = a38Service.download(resp, resultList);
        } catch (Exception e) {
            e.printStackTrace();
            logger.error(e);
        } finally {
