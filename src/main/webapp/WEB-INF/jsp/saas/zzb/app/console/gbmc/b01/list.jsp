...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12 responsive">
				<%-- 表格开始 --%>
				<form class=""id="importForm" enctype="multipart/form-data"  action="${path }/zzb/app/console/gbmc/b01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}">
					<div class="portlet-title">
						<div class="caption">名册目录</div>
						<div class="clearfix fr">
							<a id="sample_editable_1_new" class="btn green" href="${path }/zzb/app/console/gbmc/b01/add?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}">
					...
					<div class="clearfix">
						<div class="control-group">
							<div id="query" style="float: left;">
								<form action="${path }/zzb/app/console/gbmc/b01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}" method="POST" id="searchForm" name="searchForm">
                                ...
                                <tbody>
                                    <c:forEach items="${pager.datas}" var="vo">
                                        <tr style="text-overflow:ellipsis;">
                                            <td><a href="${path}/zzb/app/console/gbmc/a01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}&mcb01id=${vo.id }"><c:out value="${vo.b0101}"></c:out></a></td>
											<td><a href="${path}/zzb/app/console/gbmc/a01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}&mcb01id=${vo.id }">共<c:out value="${vo.a01Count}"></c:out>人</a></td>
                                            <td><c:out value="${vo.px}"></c:out></td>
											<td class="Left_alignment">
												<a href="${path}/zzb/app/console/gbmc/b01/edit?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&id=${vo.id }" class="">编辑</a>|
	...
	<script type="text/javascript">
				...
				$("#importForm").ajaxSubmit({
					...
					success : function(json){
						if(json.code == 1){
							...
							window.location.href="${path }/zzb/app/console/gbmc/b01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}";
						}else if(json.code == -1){
		...
		var del = function(id,itemName){
			actionByConfirm1(itemName, "${path}/zzb/app/console/gbmc/b01/delete/" + id+"?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}",{} ,function(data,status){
				if (data.success == true) {
					showTip("提示","删除成功", 2000);
					setTimeout(function(){window.location.href = "${path }/zzb/app/console/gbmc/b01/list?OWASP_CSRFTOKEN=${sessionScope.OWASP_CSRFTOKEN}&mcid=${mcid}"},2000);
				}else{
