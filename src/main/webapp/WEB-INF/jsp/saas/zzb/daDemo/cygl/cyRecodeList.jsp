...
//		});
	...
	function zzydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/daDemo/ajax/zzydRecodeList",
			type : "post",
			data : {},
			dataType : "html",
	...
	function shouquanydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/daDemo/ajax/shouquanydRecodeList",
			type : "post",
	...
	function sqydLoad(){
		$.ajax({
			url : "${path }/zzb/app/console/daDemo/ajax/sqydRecodeList",
			type : "post",
			data : {"parentId":"${parentId}","id":"${ciId}"},
			dataType : "html",
			success : function(html){
