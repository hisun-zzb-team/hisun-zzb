				...
				<div class="portlet-body form">
					...
					<form action="${path }/zzb/app/console/bwh/save" class="form-horizontal" id="form1" method="post" enctype="multipart/form-data">
						...
						<div id="pcmcGroup" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span10 m-wrap" name="pcmc"  maxlength="200" id="pcmc" value="学历材料"/>
							</div>
						...
						<div class="control-group" id="shlxGroup">
							...
							<div class="controls">
								<input type="text" class="span10 m-wrap" name="pcmc"  maxlength="200" id="pcmc" value="2001.03.01"/>
						...
						<div class="control-group" id="sjlxGroup">
							...
							<div class="controls">
								<select class="span10 m-wrap" type="text" id="influenceInfoId" name="influenceInfoId" required>
									...
									<option value="" selected>学历、学位、学绩、培训和专业技术情况材料</option>
						...
						<div id="pcsjValueGroup" class="control-group">
							...
							<div class="controls">
								<textarea class="span10" style="" rows="2" name="reportTempDesc" maxlength="400" id="reportTempDesc" >A.大学本（专）科学历需有: ①高校学生登记表 ②高校学生学习成绩登记表 ③高校毕业生登记表"</textarea>
