							...
							<div class="row-fluid">
								...
								<div class="span6 ">
									<div id="a0104Group" class="control-group">
										...
										<div class="controls">
											<SelectTag:SelectTag id="a0104" valueName="a0104Content" textClass="m-wrap span10" radioOrCheckbox="radio" selectUrl="${path}/api/dictionary/select?typeCode=GB/T2261.1-2003"/>
										</div>
									</div>
								</div>
							</div>
