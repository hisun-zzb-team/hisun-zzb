			...
			<div class="row-fluid">
				<div class="span6 ">
					<div id="a0107Group" class="control-group">
						...
						<div class="controls">
							<input type="text" class="span10 m-wrap" id="a0107" name="a0107" maxlength="64"  placeholder="日期格式 例如：2018或201801或20180101" isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"  value="${vo.a0107}"/>
						</div>
					</div>
				</div>
				<div class="span6 ">
					<div id="a0111AGroup" class="control-group">
						...
						<div class="controls">
							...
							<Tree:tree id="a0111B" valueName="a0111A"  selectClass="span10 m-wrap" treeUrl="${path}/api/dictionary/dt/tree?typeCode=ZB01-2006/GQMC" token="${sessionScope.OWASP_CSRFTOKEN}"
									   submitType="get" dataType="json" isSearch="true" dtjz="true" radioOrCheckbox="radio" isSelectTree="true" defaultkeys="${vo.a0111B}" defaultvalues="${vo.a0111A}"/>
						</div>
					</div>
				</div>
			</div>
			<div class="row-fluid">
				...
				<div class="span6 ">
					<div id="dutyLevelTimeBaseGroup" class="control-group">
						...
						<div class="controls">
							<input type="text" class="span10 m-wrap" id="dutyLevelTimeBase" name="dutyLevelTimeBase" maxlength="64"  value="${vo.dutyLevelTimeBase}"  placeholder="日期格式 例如：2018或201801或20180101" isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
						</div>
					</div>
				</div>
			</div>
					...
					<div id="gbztContentGroup" class="control-group">
						...
						<div class="controls">
							<Tree:tree id="gbztCode" valueName="gbztContent"  selectClass="span10 m-wrap" treeUrl="${path}/api/dictionary/tree?typeCode=SAN_GBZT" token="${sessionScope.OWASP_CSRFTOKEN}"
									   submitType="get" dataType="json" isSearch="false" radioOrCheckbox="radio" isSelectTree="true" defaultkeys="${vo.gbztCode}" defaultvalues="${vo.gbztContent}"/>
						</div>
					</div>
				</div>
				<div class="span6 ">
					...
					<div id="daztContentGroup" class="control-group">
						...
						<div class="controls">
							<Tree:tree id="daztCode" valueName="daztContent"  selectClass="span10 m-wrap" treeUrl="${path}/api/dictionary/tree?typeCode=SAN_DAZT" token="${sessionScope.OWASP_CSRFTOKEN}"
									   submitType="get" dataType="json" isSearch="false" isSelectTree="true" defaultkeys="${vo.daztCode}" defaultvalues="${vo.daztContent}"/>
						</div>
					</div>
				</div>
				<div class="span6 ">
			...
			<div class="row-fluid">
				<div class="span6 ">
					<div id="a3801Group" class="control-group">
						...
						<div class="controls">
							<input type="text" class="span10 m-wrap" id="a3801" name="a3801" maxlength="8"  value="${vo.a3801}"  placeholder="日期格式 例如：2018或201801或20180101" isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
						</div>
					</div>
				</div>
				<div class="span6 ">
					<div id="a3817Group" class="control-group">
						...
						<div class="controls">
							<input type="text" class="span10 m-wrap" id="a3817" name="a3817" maxlength="8"  value="${vo.a3817}"  placeholder="日期格式 例如：2018或201801或20180101" isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
						</div>
					</div>
				</div>
			</div>
