				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div id="a0243Group" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="a0243" maxlength="128" id="a0243" value=""
				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div id="aA0255AGroup" class="control-group">
							...
							<div class="controls">
                                <Tree:tree id="a0255" valueName="aA0255A"
                                           selectClass="span9 m-wrap"
                                           treeUrl="${path}/api/dictionary/tree?typeCode=ZB14-1994/RZZT"
                                           token="${sessionScope.OWASP_CSRFTOKEN}"
                                           submitType="post" dataType="json" isSearch="false"
                                           checkedByTitle="true" isSelectTree="true" defaultkeys="${a0255 }"
                                           defaultvalues="${a0255A }"/>
							</div>
						</div>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span6 ">
						<div id="a0217Group" class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span9 m-wrap" name="a0217"  required="true" maxlength="128" id="a0217" value="" />
                            </div>
						</div>
					</div>
					<%--<div class="span6 ">--%>
                        ...
                        <div id="aSfsyGroup" class="control-group">
                            ...
                            <div class="controls" style="margin-left: 200px">
                                <div style="float:left;margin-top: 5px">
                                    <label class="radio">
                                        <input type="radio" name="aSfsy" onclick="syscdw()" value="1"/>
                                        是&nbsp;&nbsp;&nbsp;
                                    </label>
                                </div>
                                <div style="float:left;margin-left:20px;margin-top: 5px">
                                    <label class="radio">
                                        <input type="radio" name="aSfsy" value="0" onclick="syscdwClose()" checked/>
                                        否
                                    </label>
                                </div>
                                <div id="syscdwDiv" style="float:left;display:none">
                                    &nbsp;&nbsp;<input type="text" class="span4 m-wrap" name="aSyq" id="aSyq" value="" />
				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div id="a0245Group" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="a0245" number="true" maxlength="128" id="a0245" value="" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row-fluid">
					<div class="span6 ">
						<div id="aZbDwzwmcGroup" class="control-group">
							...
							<div class="controls">
                                <input type="text" class="span8 m-wrap" name="aZbDwzwmc" number="true" maxlength="128" id="aZbDwzwmc" value="" />
							</div>
						</div>
					</div>
					<div class="span6 ">
					...
					<div class="span6 ">
						<div id="bSfzbGroup" class="control-group">
                            ...
                            <div class="controls" style="margin-left: 200px">
                                <div style="float:left;margin-top: 5px">
                                    <label class="radio">
                                        <input type="radio" name="bSfzb" value="1"/>
                                        是&nbsp;&nbsp;&nbsp;
                                    </label>
                                </div>
                                <div style="float:left;margin-left:20px;margin-top: 5px">
                                    <label class="radio">
                                        <input type="radio" name="bSfzb" value="0" checked/>
                                        否
                                    </label>
                                </div>
                            </div>
				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div id="a0267Group" class="control-group">
							...
							<div class="controls">
                                <input type="text" class="span9 m-wrap" name="a0267" number="true" maxlength="128" id="a0267" value="" />
							</div>
						</div>
					</div>
				</div>
					...
					<div class="span6 ">
						<div id="a0225Group" class="control-group">
							...
							<div class="controls" style="margin-left: 180px">
                                <input type="text" class="span9 m-wrap" name="a0225" number="true" maxlength="128" id="a0225" value="${a0225}" />
							</div>
						</div>
					</div>
					<div class="span6 ">
...
<script type="text/javascript">
        ...
        function selectZw (event, treeId, treeNode){
            $("#a0217").val(treeNode.name);//赋值
        }
