	...
	<div class="portlet box grey">
		...
		<div class="portlet-title">
			...
			<div class="caption">
				...
				<span class="hidden-480">修改学历及学习经历</span>
		...
		<form action="${path}/zzb/gbgl/a02/save" class="form-horizontal" id="addXxjlform" method="post">
			...
			<input type="hidden" id="a0800" name="a0800" value="${vo.a0800}">
						...
						<div id="a0801AGroup" class="control-group">
							...
							<div class="controls" >
								<Tree:tree id="a0801B" valueName="a0801A"
										   ...
										   checkedByTitle="true" isSelectTree="true" defaultkeys="${vo.a0801B}"
										   defaultvalues="${vo.a0801A}"/>
							</div>
						</div>
					</div>
					<div class="span6 ">
						<div id="a0811Group" class="control-group">
							...
							<div class="controls" style="margin-left: 200px">
								<label class="radio">
									<input type="radio" name="a0811" value="1" <c:if test="${vo.a0811=='1'}">checked</c:if>/>
									全日制&nbsp;&nbsp;&nbsp;
								</label>
								<label class="radio">
									<input type="radio" name="a0811" value="0" <c:if test="${vo.a0811=='0'}">checked</c:if>/>
									在职
								</label>
							</div>
						</div>
						...
						<div id="a0831Group" class="control-group">
                            ...
                            <div class="controls">
								<Tree:tree id="a0831" valueName="a0831A"
										   ...
										   token="${sessionScope.OWASP_CSRFTOKEN}"
										   submitType="post" dataType="json" isSearch="false"
										   checkedByTitle="true" isSelectTree="true" defaultkeys="${vo.a0831}"
										   defaultvalues="${vo.a0831A}"/>
                            </div>
						</div>
					</div>
				</div>
				...
				<div class="row-fluid">
					<div class="span6 ">
						<div id="aXlzsbhGroup" class="control-group">
							...
							<div class="controls" >
								<input type="text" class="span9 m-wrap" name="aXlzsbh" maxlength="128" id="aXlzsbh" value="${vo.aXlzsbh}" />
							</div>
						</div>
					</div>
					<div class="span6 ">
						<div id="a0821AGroup" class="control-group">
							...
							<div class="controls">
                                <Tree:tree id="a0821" valueName="a0821A"
                                           ...
                                           token="${sessionScope.OWASP_CSRFTOKEN}"
                                           submitType="post" dataType="json" isSearch="false"
                                           checkedByTitle="true" isSelectTree="true" defaultkeys="${vo.a0821}"
                                           defaultvalues="${vo.a0821A}"/>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="row-fluid">
                    <div class="span6 ">
                        <div id="aXlzssjGroup" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="aXlzssj"  maxlength="128" id="aXlzssj" value="${vo.aXlzssj}"
                        ...
                        <div id="a0827AGroup" class="control-group">
                            ...
                            <div class="controls">
                                <SelectTag:SelectTag id="a0827" needNullValue="true"
                                                     valueName="a0827A"
                                                     defaultkeys="${vo.a0827}" token="${sessionScope.OWASP_CSRFTOKEN}"
                                                     defaultvalues="${vo.a0827A}"
				...
				<div class="row-fluid">
						...
						<div id="a0901AGroup" class="control-group">
							...
							<div class="controls">
								<Tree:tree id="a0901B" valueName="a0901A"
										   ...
										   token="${sessionScope.OWASP_CSRFTOKEN}"
										   submitType="post" dataType="json" isSearch="false"
										   checkedByTitle="true" isSelectTree="true" defaultkeys="${vo.a0901B}"
										   defaultvalues="${vo.a0901A}"/>
							</div>
					...
					<div class="span6 ">
						<div id="a0804Group" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="a0804" maxlength="128" id="a0804" value="${vo.a0804}"
									   placeholder="日期格式 例如：2018或201801或20180101"  isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
							</div>
						</div>
					</div>
				...
				<div class="row-fluid">
					...
					<div class="span6 ">
						<div id="a0807Group" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="a0807" number="true" maxlength="128" id="a0807" value="${vo.a0807}"
									   placeholder="日期格式 例如：2018或201801或20180101"  isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
							</div>
						</div>
					</div>
				...
				<div class="row-fluid">
					<div class="span6 ">
						<div id="aXwzsbhGroup" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="aXwzsbh" maxlength="128" id="aXwzsbh" value="${vo.aXwzsbh}" />
							</div>
						</div>
					</div>
					<%--<div class="span6 ">--%>
				...
				<div class="row-fluid">
					<div class="span6 ">
						<div id="aXwzssjGroup" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" name="aXwzssj" maxlength="128" id="aXwzssj" value="${vo.aXwzssj}"
									   placeholder="日期格式 例如：2018或201801或20180101"  isDate="true" dateformat="yyyy,yyyymm,yyyymmdd"/>
							</div>
						</div>
					</div>
					<div class="span6 ">
						<div id="a0814Group" class="control-group">
							...
							<div class="controls">
                                <input type="text" class="span9 m-wrap" name="a0814" maxlength="128" id="a0814" value="${vo.a0814}" />
							</div>
						</div>
					</div>
				</div>
