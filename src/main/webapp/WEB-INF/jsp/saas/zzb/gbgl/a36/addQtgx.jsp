		...
		<div class="span12">
			...
			<div class="portlet box grey">
				...
				<div class="portlet-title">
					<div class="caption">
						<span class="hidden-480">添加其他家庭成员及主要社会关系</span>
					</div>
				</div>
				...
				<div class="portlet-body form">
					...
					<form action="${path }/zzb/dzda/e01z1/save" class="form-horizontal" id="addQtgxform" method="post" enctype="multipart/form-data">
						...
						<div id="a3647Group" class="control-group">
							...
							<div class="controls">
								<input type="text" class="span9 m-wrap" number="true" name="a3647" maxlength="128" id="a3647" value="${a3647}" />
							</div>
						</div>
...
<script type="text/javascript">
    ...
    var addQtgxform = new EstValidate("addQtgxform");
    $(function(){
        $("#submitbutAdd").on("click",function(){
            var bool = addQtgxform.form();
            if(bool){
                $.ajax({
                    url : "${path}/zzb/gbgl/a36/saveQtgx",
                    type : "post",
                    data : $('#addQtgxform').serialize(),
                    dataType : "json",
                    headers: {
