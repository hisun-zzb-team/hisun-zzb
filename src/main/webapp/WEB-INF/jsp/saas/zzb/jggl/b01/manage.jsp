...
<div class="tabbable tabbable-custom" style="margin-bottom: 0px">
    <ul class="nav nav-tabs" style="font-size: 14px;font-weight: bold;" id="tabs">
        ...
        <li style='<c:if test="${bSjlx ==2}"> display: none</c:if>'><a id="#tab_1_2" href="#tab_1_1" data-toggle="tab">编制情况</a>
        </li>
        <li style='<c:if test="${bSjlx ==2}"> display: none</c:if>'><a id="#tab_1_3" href="#tab_1_1" data-toggle="tab">职务管理</a>
        </li>
        <li style='<c:if test="${bSjlx ==2 ||bSjlx ==1}"> display: none</c:if>'><a id="#tab_1_4" href="#tab_1_1"
                                                                                   data-toggle="tab">换届信息</a></li>
        <li style='<c:if test="${bSjlx ==2 ||bSjlx ==1}"> display: none</c:if>'><a id="#tab_1_5" href="#tab_1_1"
