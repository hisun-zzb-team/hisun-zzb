    ...
    <div class="portlet box grey">
        ...
        <div class="portlet-title">
            ...
            <div class="caption">
                ...
                <span class="hidden-480">增加换届信息</span>
        ...
        <div id="addhjxxDiv" class="portlet-body">
            <form action="${path }/zzb/jggl/b10/updateOrSave?b01Id=${b01Id}" class="form-horizontal" id="b10Form" method="post">
                <dl class="dlattrbute">
                    <dd>
                        <div class="row-fluid">
                            <div class="span6 ">
                                <div id="b1001Group" class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span10 m-wrap" name="b1001" id="b1001"
                                               number="true" maxlength="128" value=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="span6 ">
                        ...
                        <div  >
                            <center>
                                <div style="margin:auto;">
                                    <button class="btn green" type="button" onclick="save()">确定</button>
