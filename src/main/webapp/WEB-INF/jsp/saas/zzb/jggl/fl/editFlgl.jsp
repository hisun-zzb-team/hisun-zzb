    ...
    <div class="portlet box grey">
        ...
        <form action="${path}/zzb/dzda/e01z2/ajax/save" class="form-horizontal" id="form1" method="post">
            ...
            <div id="flGroup" class="control-group">
                ...
                <div class="controls">
                    <input size="16" type="text" required class="span10 m-wrap" value="${vo.fl }"
                           id="fl" name="fl" >
                </div>
            ...
            <div id="pxGroup" class="control-group">
                ...
                <div class="controls">
                    <input size="16" type="text" number="true" class="span10 m-wrap" value="${vo.px }"
                           id="px" name="px" >
                </div>
